  ...
  create view "operacoes"."public"."fato_controlemercadorias__dbt_tmp"
  ...
  CAST(SPLIT_PART(data_pedido, '/', 1) AS INT) AS numero_operacao,
...
FROM "operacoes"."public"."f_controle_mercadorias"
  );